...
\usepackage{bookman}
%\usepackage{georgia}
\usepackage{hyperref}  %kp: http://en.wikibooks.org/wiki/LaTeX/Hyperlinks#.5Curl
...
{\LARGE Krishna P. Adhikari, Ph.D.}\\[.5cm]
%SEK 1/24/14: You should either put "Dr." in front of your name or ", Ph.D." behind it, on the same line. Remove the "Ph.D., " from the next line.
...
\item Monarch Mentor to new International Students, Office of Inter-cultural Relations, Old Dominion University, 2006. %\item Participation in Monarch Mentor Program (Mentoring New International Students at Old Dominion University), 2006
%%%%%%%%%%\item Multiple Blood and Platelets Donations (Nepal, USA)  %SEK: 1/24/14: You are quite thorough listing your accomplishments and activities. However, try to limit it to strictly "professional" activities. So, for instance, blood and platelet donations (while commendable) do not belong in your CV
\end{itemize}
...
\item Mapping Generalized GDH Integral at Low $Q^2$, Poster presentation, \href{http://www.tunl.duke.edu/nnpss/web.tunl.nnpss.reg.php}{National Nuclear Physics Summer School (NNPSS}), Chapel Hill, NC, 2011. %\href{http://www.int.washington.edu/NNPSS/schools.html}{National Nuclear Physics Summer School} (NNPSS), 2011 
\item EG4 Experiment, Poster presentation, \href{http://www.grc.org/programs.aspx?year=2010&program=photonuc}{Gordon Research Conference on Photonuclear Reactions}, Tilton School, NH, 2010. %Dates: 08/01/2010 - 08/06/2010 Location: Tilton School in Tilton NH United States 
